...
| `road_service.py` | ประเมินความเสี่ยงน้ำท่วมขัง **รายถนน** ทั้ง กทม. และปริมณฑล ทุก 2 นาที: รวมถนนทุกสายจาก `traffic_service` (ชื่อ+จุดกึ่งกลาง+% รถติด) เข้ากับเซ็นเซอร์น้ำบนถนน (`flood_service`, เฉพาะ กทม.), สถานีวัดฝน 24 ชม. ~180 จุด และสถานีระดับน้ำคลอง/แม่น้ำ ~70 จุด (`water_service`) ด้วยระยะทางจริง แล้วให้คะแนน 0-100 + Gemini เขียนบทวิเคราะห์สายที่เสี่ยงสุด · สายที่ไม่มีเซ็นเซอร์บนถนนจะทำเครื่องหมาย `measured: false` (`/api/roads/risk`) |
